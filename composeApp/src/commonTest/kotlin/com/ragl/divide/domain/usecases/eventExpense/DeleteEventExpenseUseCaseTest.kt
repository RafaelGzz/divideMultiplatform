...
class DeleteEventExpenseUseCaseTest {
    ...
    private val useCase = DeleteEventExpenseUseCase(mockGroupRepository, mockUserStateHolder)
    ...
    fun `should return success when event expense is deleted successfully`() = runTest {
        ...
        assertTrue(mockUserStateHolder.deleteEventExpenseCalled)
        assertEquals(groupId, mockUserStateHolder.receivedGroupId)
        assertEquals(eventExpense, mockUserStateHolder.receivedEventExpense)
    }
    ...
    private class MockUserStateHolder : UserStateHolder {
        var deleteEventExpenseCalled = false
        var receivedGroupId: String? = null
        var receivedEventExpense: EventExpense? = null
