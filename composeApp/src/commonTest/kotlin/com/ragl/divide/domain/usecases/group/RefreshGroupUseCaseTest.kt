...
class RefreshGroupUseCaseTest {
    ...
    private val useCase = RefreshGroupUseCase(mockGroupRepository, mockUserStateHolder)
    ...
    fun `should return success with group when refresh is successful`() = runTest {
        ...
        mockGroupRepository.shouldReturnGroup = expectedGroup
        ...
        assertTrue(mockUserStateHolder.updateGroupInStateCalled)
        assertEquals(groupId, mockUserStateHolder.receivedGroupId)
        assertEquals(expectedGroup, mockUserStateHolder.receivedGroup)
    }
    ...
    private class MockUserStateHolder : UserStateHolder {
        var updateGroupInStateCalled = false
        var receivedGroupId: String? = null
