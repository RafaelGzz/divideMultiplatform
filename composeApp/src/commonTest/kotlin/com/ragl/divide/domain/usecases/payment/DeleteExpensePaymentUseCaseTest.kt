...
class DeleteExpensePaymentUseCaseTest {
    ...
    private val useCase = DeleteExpensePaymentUseCase(mockUserRepository, mockUserStateHolder)

    @Test
    fun `should return success when expense payment is deleted successfully`() = runTest {
        // Given
        val expense = Expense(
            id = "expense123",
            title = "Test Expense",
