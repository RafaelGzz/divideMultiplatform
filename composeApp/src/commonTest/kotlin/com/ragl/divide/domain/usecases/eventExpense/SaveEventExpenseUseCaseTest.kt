...
class SaveEventExpenseUseCaseTest {
    ...
    private val useCase = SaveEventExpenseUseCase(mockGroupRepository, mockUserStateHolder)
    ...
    fun `should return success when event expense is saved successfully`() = runTest {
        ...
        mockGroupRepository.shouldReturnEventExpense = savedEventExpense
        ...
        assertEquals(savedEventExpense, result.expense)
        assertEquals(groupId, mockGroupRepository.receivedGroupId)
        assertEquals(eventExpense, mockGroupRepository.receivedEventExpense)
        assertTrue(mockUserStateHolder.saveEventExpenseCalled)
        assertEquals(groupId, mockUserStateHolder.receivedGroupId)
        assertEquals(savedEventExpense, mockUserStateHolder.savedEventExpense)
    }
    ...
    private class MockUserStateHolder : UserStateHolder {
        var saveEventExpenseCalled = false
        var receivedGroupId: String? = null
        var savedEventExpense: EventExpense? = null
        ...
        override fun saveEventExpense(groupId: String, expense: EventExpense) {
            saveEventExpenseCalled = true
            receivedGroupId = groupId
            savedEventExpense = expense
        }
