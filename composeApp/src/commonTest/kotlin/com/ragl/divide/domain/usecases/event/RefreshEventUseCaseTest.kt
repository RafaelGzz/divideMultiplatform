...
class RefreshEventUseCaseTest {
    ...
    private val useCase = RefreshEventUseCase(mockGroupRepository, mockUserStateHolder)
    ...
    fun `should return success with event when refresh is successful`() = runTest {
        ...
        mockGroupRepository.shouldReturnEvent = expectedEvent
        ...
        assertTrue(mockUserStateHolder.updateEventInStateCalled)
        assertEquals(groupId, mockUserStateHolder.receivedGroupId)
        assertEquals(eventId, mockUserStateHolder.receivedEventId)
        assertEquals(expectedEvent, mockUserStateHolder.receivedEvent)
    }
    ...
    private class MockUserStateHolder : UserStateHolder {
        var updateEventInStateCalled = false
        var receivedGroupId: String? = null
        var receivedEventId: String? = null
        ...
        override fun updateEventInState(groupId: String, eventId: String, updatedEvent: Event) {
            updateEventInStateCalled = true
            receivedGroupId = groupId
            receivedEventId = eventId
            receivedEvent = updatedEvent
        }
