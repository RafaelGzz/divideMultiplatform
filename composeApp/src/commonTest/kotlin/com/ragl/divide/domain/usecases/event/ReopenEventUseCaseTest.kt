...
class ReopenEventUseCaseTest {
    ...
    private val useCase = ReopenEventUseCase(mockGroupRepository, mockUserStateHolder)
    ...
    fun `should return success when event is reopened successfully`() = runTest {
        ...
        assertTrue(mockUserStateHolder.reopenEventCalled)
